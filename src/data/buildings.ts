export default {
  ...
  'steady': {
    ...
    cost: 20,
    cost_multiplier: 2,
    yield_multipliers: { karma_positive: 3.3 },
    cost_type: 'karma_positive',
    yields: { karma_positive: 100 },
    duration: 5000,
  ...
  'chaos': {
    ...
    cost: 20,
    cost_multiplier: 1.5,
    yield_multipliers: { karma_positive: 1.5 },
    cost_type: 'karma_positive',
    yields: { karma_positive: 20 },
    duration: 2000,
    duration_reduction: 0,
    polarity_bias: 0,
  ...
  'zealot': {
    ...
    cost: 10000,
    cost_multiplier: 1.5,
    yield_multipliers: { karma_positive: 3 },
    cost_type: 'karma_positive',
    yields: { karma_positive: 2000 },
    duration: 5000,
